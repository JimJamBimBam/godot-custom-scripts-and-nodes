...
const GLOBAL_MESSENGER = "res://addons/global_messenger/nodes/global_messenger.gd"

var _global_messenger_inspector: Node

func _enter_tree() -> void:
	add_autoload_singleton("GlobalMessenger", GLOBAL_MESSENGER)
	
	_global_messenger_inspector = load("res://addons/global_messenger/ui/global_messenger_inspector.tscn").instantiate()
